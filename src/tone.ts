...
const TONE_PRESETS: Record<string, TonePreset> = {
  ...
  casual: {
    name: "casual",
    prompt:
      "必ず日本語で返答してください。カジュアルでフレンドリーな口調で返答してください。くだけた言葉遣いで、会話するように話してください。",
  },
  formal: {
    name: "formal",
    prompt:
      "必ず日本語で返答してください。丁寧でビジネスライクな口調で返答してください。敬語を使い、プロフェッショナルな言葉遣いを心がけてください。",
  },
  funny: {
    name: "funny",
    prompt:
      "必ず日本語で返答してください。ユーモアたっぷりに返答してください。ウィットに富んだ面白い表現を使いつつ、役に立つ回答を心がけてください。",
  },
};
